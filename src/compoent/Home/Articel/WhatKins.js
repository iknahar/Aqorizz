      ...
      <div className="product-detilas row">
        ...
        <div className="similar-img row">
          ...
          <div className="col-lg-3 col-sm-12 col-md-6">
            {" "}
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQhQdcy_tFHxwaMzUvyilObc0v73MWBPXVCMmW0stjuaKiOZq45cFhv53WDNl_avxAzPTg&usqp=CAU"
              alt=""
            />
            <h4>Convict Cichlid</h4>
          </div>
          <div className="col-lg-3 col-sm-12 col-md-6">
            {" "}
            <img
              src="https://media.hswstatic.com/eyJidWNrZXQiOiJjb250ZW50Lmhzd3N0YXRpYy5jb20iLCJrZXkiOiJnaWZcL2JldHRhLWZpc2guanBnIiwiZWRpdHMiOnsicmVzaXplIjp7IndpZHRoIjo1NDAsImhlaWdodCI6MzAzfX19"
              alt=""
            />
          ...
          <div className="col-lg-3 col-sm-12 col-md-6">
            <img
              src="https://images.unsplash.com/photo-1522720833375-9c27ffb02a5e?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8YXF1YXJpdW0lMjBmaXNofGVufDB8fDB8fA%3D%3D&w=1000&q=80"
              alt=""
            />{" "}
            <h4>Betta Fish</h4>
          </div>
          <div className="col-lg-3 col-sm-12 col-md-6">
            <img
              src="https://30a.com/wp-content/uploads/2020/12/1076px-Clown_fish_in_the_Andaman_Coral_Reef.jpg"
              alt=""
            />{" "}
            <h4>Goldfish</h4>
          </div>
